                            ...
                            <div class="content">
                                <div id="exTab2"> 
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>Nama</label>
                                                            <input type="text" name="nama" class="form-control border-input" disabled value="{{ $detailKunjungan->pasien->NamaPasien }}">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="noktp" class="form-control border-input" disabled value="{{ $detailKunjungan->pasien->NoKtp }}">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="ruang" class="form-control border-input" disabled value="{{ $detailKunjungan->unit->NamaRuangan }}">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">    
                                                            ...
                                                            <input type="timestamp" name="tglmasuk" class="form-control border-input" disabled value="{{ $detailKunjungan->created_at}}">
                                    ...
                                    <div class="tab-pane" id="2">
                                        <br>
                                        @if($detailKunjungan->IdRujukan == 99)
                                        <div class="row">
                                            <div class="col-sm-8 col-sm-offset-2">

                                                <!-- Form -->
                                                <form method="post" action="{{ url('/rawatinap/tambah/rujukan') }}"> 
                                                    {{ csrf_field() }}
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('/rawatinap/hapus/obat/'.$detailKunjungan->resep->IdResep.'/'.$obat->IdObat) }}"><button class="btn btn-danger">Hapus</button></a></td>
                                                </tr>
                                                @endforeach
                                                @endif
                                            </tbody>
