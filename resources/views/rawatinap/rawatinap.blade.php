            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                                           ...
                                           <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/rawatinap/pemeriksaan/{{ $rawatinap->IdRawatInap }}"><button class="btn btn-primary bold">Periksa</button></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                        ...
                        <a href="/rawatinap/rekap"><button class="btn btn-primary bold btn-fill"><i class="ti-receipt"></i> Rekap Rawat Inap</button></a>
